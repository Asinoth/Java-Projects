...
public class hashListmain {
	...
	public static void main(String[] args) throws IOException {
		...
		LMovieHashTable sortedList = new SLMovieHashTable(new MovieListComparatorByYear());
		LMovieHashTable unsortedList = new ULMovieHashTable();
		LMovieHashTable selfAdjustingList = new SALMovieHashTable();
				...
				if(operation==1){
				   ...
				   System.out.println(sortedList.toString());
					...
					if(operation==1){
						...
						System.out.println("It took "+(time2-time1)+" time to calculate for the unsorted hash list");
						//----------------------------//
						time1=System.nanoTime();
						System.out.println("The movie with the best rank is "+meth.maxRank(sortedList));
						time2=System.nanoTime();
						System.out.println("It took "+(time2-time1)+" time to calculate for the sorted hash list");	
						//----------------------------//
						time1=System.nanoTime();
						System.out.println("The movie with the best rank is "+meth.maxRank(selfAdjustingList));
						time2=System.nanoTime();
						System.out.println("It took "+(time2-time1)+" time to calculate for the selfAdjusting hash List");
					}else if(operation==2){
						//----------------------------//
