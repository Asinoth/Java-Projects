...
public class Board {
    ...
    //starts the game, setting the table
    //we have 5 Arraylist each corresponding to a space
    //on the table, upon which we will collect tiles
    public void init()
    {
    	int n = 5; 
    	  
        ArrayList<Tile>[] table = new ArrayList[n]; 
  
        // initializing 
        for (int i = 0; i < n; i++) { 
            table[i] = new ArrayList<Tile>(); 
        } 
        
        String[] area_names = {"Perioxi Eisodou", "Perioxi Amforewn", "Perioxi Mwsaikwn", "Perioxi Agalmatwn", "Perioxi Skeletwn"};
